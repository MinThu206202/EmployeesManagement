...
namespace EmployeesManagement.Controllers
{
    public class ApprovalsUserMatricesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ApprovalsUserMatrices.Include(a => a.DocumentType).Include(a => a.User).Include(a => a.WorkFlowUserGroup);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var approvalsUserMatrix = await _context.ApprovalsUserMatrices
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var approvalsUserMatrix = await _context.ApprovalsUserMatrices.FindAsync(id);
            if (approvalsUserMatrix == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (approvalsUserMatrix != null)
            {
                _context.ApprovalsUserMatrices.Remove(approvalsUserMatrix);
            }
        ...
        {
            return _context.ApprovalsUserMatrices.Any(e => e.Id == id);
        }
    }
}
