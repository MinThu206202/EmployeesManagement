...
namespace EmployeesManagement.Controllers
{
    public class ApprovalEntriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ApprovalEntries.Include(a => a.DocumentType).Include(a => a.LastModifiedBy).Include(a => a.Status);
        ...
        public async Task<IActionResult> Create([Bind("id,RecordId,DocumentTypeId,SequenceNo,ApproveId,StatusId,DateSentForApproval,LastModifiedOn,LastModifiedById,Comments")] ApprovalEntry approvalEntry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,RecordId,DocumentTypeId,SequenceNo,ApproveId,StatusId,DateSentForApproval,LastModifiedOn,LastModifiedById,Comments")] ApprovalEntry approvalEntry)
        {
